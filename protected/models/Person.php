...
class Person extends CActiveRecord
{
    ...
    */
    public function rules()
    {
        ...
        return array(
                    ...
                    array('t_birthday', 'safe'),
                // The following rule is used by search().
        // @todo Please remove those attributes that should not be searched.
        array('id, user_id, name, fullname, t_birthday, ident_code, passport_data, address_data, photo_link, contact_data, is_enterpreneur', 'safe', 'on'=>'search'),
        );
    }
    ...
    */
    ...
    return array(
            'id' => Yii::t('site','ID'),
            'user_id' => Yii::t('site','if have user account'),
            'name' => Yii::t('site','Name'),
            'fullname' => Yii::t('site','Fullname'),
            't_birthday' => Yii::t('site','T Birthday'),
            'ident_code' => Yii::t('site','id or other gov. number
'),
    ...
    */
    ...
    $criteria=new CDbCriteria;
		...
		$criteria->compare('t_birthday',$this->t_birthday,true);
